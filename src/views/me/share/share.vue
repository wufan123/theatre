      ...
      <x-dialog v-model="showDialogStyle" hide-on-blur
        ...
        <div class="dialog">
          <div class="bg body">
            ...
            <p>扫二维码向朋友分享</p>
            <!--<div class="type">-->
              <!--<div class="item" @click="ShareFriend"><i class="wx"></i>-->
                <!--<p>微信</p></div>-->
              <!--<div class="item" @click="friendArea"><i class="friends"></i>-->
                <!--<p>朋友圈</p></div>-->
              <!--<div class="item" @click="ShareQQ"><i class="qq"></i>-->
                <!--<p>QQ</p></div>-->
              <!--<div class="item" @click="ShareSina"><i class="sina"></i>-->
                <!--<p>QQ空间</p></div>-->
              <!--&lt;!&ndash; <div class="item"> <i class="link"></i> <p>复制邀请链接</p> </div> &ndash;&gt;-->
            <!--</div>-->
          </div>
          <div class="bg foot">
...
<style lang="less" scoped>
  ...
  .warn .title {
    ...
    background-image: url('../../../assets/images/me/share_title_bg.png')
  }
      ...
      .type {
        ...
        .item {
          ...
          i {
            ...
            background-size: 100% 100%;
            &.wx {
              background-image: url('../../../assets/images/me/wx.png');
            }
            &.friends {
              background-image: url('../../../assets/images/me/friends.png');
            }
            &.qq {
              background-image: url('../../../assets/images/me/qq.png');
            }
            &.sina {
              background-image: url('../../../assets/images/me/sina.png');
            }
            &.link {
              background-image: url('../../../assets/images/me/link.png');
            }
          }
        }
      }
