    ...
    <scroller lock-x scrollbar-y>
      <div flex-box="1" class="scroll">
        ...
        <div flex="dir:left main:justify cross:center" class="menuCell">
          <p class="top-bg"></p>
          <div flex="dir:top main:center cross:center" v-for="(item,index) in munuList" @click="$router.push({ path:item.pathName, query:item.params})">
    ...
    contentUrl(arr) {
      return arr.map(data => {
        switch (parseInt(data.redirectType)) {
          ...
          case 3:
            //此处需特殊处理，加#
            data.contentUrl = `#/IntroduceDetail?contentUrl=${
              data.contentUrl
            }&title=${data.title}&redirectType=${
              data.redirectType
...
.homeOut {
  ...
  .go-buy {
    ...
    &.yyx {
      ...
      background: url("../../assets/images/home/yyx_img.png") no-repeat;
      background-size: 345px 225px;
      .detail span {
        background: url("../../assets/images/home/yyx_title.png") no-repeat;
        background-size: 101px 41px;
      }
      .detail .btn {
        background: url("../../assets/images/home/go_buy_btn.png") no-repeat;
    ...
    &.zhq {
      ...
      background: url("../../assets/images/home/zhq_img.png") no-repeat;
      background-size: 345px 225px;
      .detail span {
        background: url("../../assets/images/home/zhq_title.png") no-repeat;
        background-size: 101px 41px;
      }
      .detail .btn {
        background: url("../../assets/images/home/thzh_btn.png") no-repeat;
        background-size: 114px 25px;
      }
    }
  }
  .tip {
    height: 30px;
    background: url("../../assets/images/home/tip_bg.jpg") no-repeat;
  ...
  .menuCell {
    ...
    .top-bg {
      background: url(../../assets/images/home/home_wy_bg.png) repeat-x;
      width: 100%;
